...
import sys, os
from ZeroTrace.crawler import Crawler
from ZeroTrace.attacks import *
from ZeroTrace.utils import get_url_host, validate_url, dict_iterate, read_config, check_boolean_option
from ZeroTrace.client import Client, NotAPage, RedirectedToExternal
from ZeroTrace.app_detect import app_detect
from ZeroTrace.logger import Log
...
ASCII_ART = r"""
  ______          ______               
 /_  __/___  ____/_  __/___  _________ 
  / / / __ \/ __ \/ / / __ \/ ___/ __ \
 / / / /_/ / /_/ / / / /_/ / /  / /_/ /
...
"""
DESC = r"""
ZeroTrace - Your Digital Security Guardian
